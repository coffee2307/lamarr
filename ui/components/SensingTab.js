/**
 * LAMARR SensingTab — Trực quan CSI thực (Gaussian splat + heatmap)
 */
...
export class SensingTab {
  ...
  _buildDOM() {
    this.container.innerHTML = `
      <h2>Cảm biến WiFi LAMARR — CSI 3D</h2>
      ...
      <div class="sensing-layout">
        ...
        <div class="sensing-viewport" id="sensingViewport">
          <div class="sensing-loading">Đang tải engine 3D...</div>
        </div>
        ...
        <div class="sensing-panel">
          ...
          <!-- Setup info -->
          <div class="sensing-card">
            <div class="sensing-card-title">Về dữ liệu CSI</div>
            <p class="sensing-about-text">
              Heatmap từ <strong>signal_field</strong> — CSI thật từ ESP32, không skeleton suy diễn.
              Hiện có <strong><span id="sensingNodeCount">0</span> node ESP32</strong>.
              Thêm 3–4 node để tăng độ phân giải không gian.
            </p>
          </div>

          <!-- Node Status -->
          <div class="sensing-card" id="sensingNodeCards">
            <div class="sensing-card-title">TRẠNG THÁI NODE</div>
  ...
  _onStateChange(state) {
    ...
    if (banner) {
      ...
      const bannerConfig = {
        'live':              { text: 'CSI TRỰC TIẾP — ESP32',              cls: 'sensing-source-live' },
        'server-simulated':  { text: 'MÔ PHỎNG — CHƯA CÓ ESP32',           cls: 'sensing-source-server-sim' },
        'reconnecting':      { text: 'ĐANG KẾT NỐI...',                    cls: 'sensing-source-reconnecting' },
